...
extension UIBarButtonItem {
    ...
    static func RD_imageItem(imageName: String, target: AnyObject, action: Selector) -> UIBarButtonItem {
    ...
    /// 返回按钮 带箭头的
    static func RD_backItem(imageName: String, target: AnyObject, action: Selector) -> UIBarButtonItem {
    ...
    static func RD_customItem(title: String, titleColor: UIColor, imageName: String, target: AnyObject, action: Selector,
