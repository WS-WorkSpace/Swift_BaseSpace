...
class OneTabViewController: BaseViewController {
...
//        }
        ...
        tabview.frame = CGRectMake(0, distanceTop, kScreenWidth, kScreenHeight-distanceTop-distanceBottom)
...
extension OneTabViewController:UITableViewDataSource{
...
extension OneTabViewController:UITableViewDelegate{
