//
//  SessionBackImageSectionViewController.swift
//  Swift_Base
//
...
class SessionBackImageSectionViewController: UIViewController {
    ...
    private lazy var collV = UICollectionView(frame: CGRect(x: 0, y: 0, width: 0, height: 0), collectionViewLayout: layout).then {
        ...
        $0.delegate = self
        $0.dataSource = self
        $0.register(ContentCell.self, forCellWithReuseIdentifier: ContentCell.COMMONEPRODUCT_CID)
...
//            make.edges.equalToSuperview()
            make.edges.equalTo(UIEdgeInsets(top: distanceTop, left: 0, bottom: kBottomSafeHeight, right: 0))
        }
    }
}

extension SessionBackImageSectionViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SectionDecorationLayoutDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: ContentCell = collectionView.dequeueReusableCell(withReuseIdentifier: ContentCell.COMMONEPRODUCT_CID, for: indexPath) as! ContentCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let W: CGFloat = (kScreenWidth - 50)/3
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        if section == 0 {
            ...
            return CGSize(width: kScreenWidth, height: Self.HADERVIEW_H)
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: SectionDecorationLayout, decorationColorForSectionAt section: Int) -> UIColor {
        ...
        case 1:
            return UIColor(red: 196/255.0, green: 26/255.0, blue: 187/255.0, alpha: 1)
        case 2:
