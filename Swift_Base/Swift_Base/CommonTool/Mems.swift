...
///// 辅助查看内存的小工具类
///*
// let type1 = Metadata.type(type(of: tabview))
////        print(type1)
// //打印的genericTypes 表示泛型   ,super = nil
// let type2 = Metadata.type(UITableView.self)
////        print(type2)
// //窥探内存的方法
// let type2 = Metadata.type(DataRequest.self)
// print(type2)
// show(ref: dataRequest) //x/16xb dataRequest
// let count = CFGetRetainCount(dataRequest)
// print("-----count---:",count)
//
//
