...
public extension CALayer {
    ...
    func animationMovePoint(to endPoint: CGPoint,
        ...
        baseBasicAnimation(keyPath: "position", startValue: self.position, endValue: endPoint, duration: duration, delay: delay, repeatNumber: repeatNumber, removedOnCompletion: removedOnCompletion, option: option)
    }
    ...
    func animationMoveX(moveValue: Any?,
                        ...
                        removedOnCompletion: Bool = false,
                        option: CAMediaTimingFunctionName = .default) {
        baseBasicAnimation(keyPath: "transform.translation.x", startValue: self.position, endValue: moveValue, duration: duration, delay: delay, repeatNumber: repeatNumber, removedOnCompletion: removedOnCompletion, option: option)
    }
    ...
    func animationMoveY(moveValue: Any?,
                        ...
                        removedOnCompletion: Bool = false,
                        option: CAMediaTimingFunctionName = .default) {
        baseBasicAnimation(keyPath: "transform.translation.y", startValue: self.position, endValue: moveValue, duration: duration, delay: delay, repeatNumber: repeatNumber, removedOnCompletion: removedOnCompletion, option: option)
    }
    ...
    func animationCornerRadius(cornerRadius: Any?,
                               ...
                               removedOnCompletion: Bool = false,
                               option: CAMediaTimingFunctionName = .default) {
        baseBasicAnimation(keyPath: "cornerRadius", startValue: self.position, endValue: cornerRadius, duration: duration, delay: delay, repeatNumber: repeatNumber, removedOnCompletion: removedOnCompletion, option: option)
    }
    ...
    func baseBasicAnimation(keyPath: String,
        ...
        self.add(translatonAnimation, forKey: nil)
    }
}
